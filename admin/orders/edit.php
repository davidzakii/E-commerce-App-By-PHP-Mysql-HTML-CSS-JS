...
$updateOrderQuery = "UPDATE `order` SET `date`='$orderDate',`product_id`=$orderProduct,`user_id`=$orderUser WHERE `code`=$code";
try{
  $orderUpdateResult = $connect->query($updateOrderQuery);
      ...
      <div class="page-wrapper">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <?php if(isset($orderUpdateResult )){ ?>
                  <p class="alert alert-success">Updated Order Done</p>
                <?php } ?>
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']).'?code='.$code; ?>" class="form-horizontal" method="post">
                  <div class="card-body">
